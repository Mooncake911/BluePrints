...
class Node_Graphics(QtWidgets.QGraphicsItem):
    def __init__(self):
        ...
        self.title_color = QtGui.QColor(255, 0, 0)
        ...
        self._width = 20  # The Width of the python_node_interface
        self._height = 20  # the height of the python_node_interface
        self._pins = []  # A list of pins


        self.node_color = QtGui.QColor(25, 25, 25, 200)
        ...
        self.status_path = QtGui.QPainterPath()  # A path showing the status of the python_node_interface
    ...
    def set_color(self, title_color=(255, 0, 0), background_color=(25, 25, 25, 200)):
        self.title_color = QtGui.QColor(*title_color)
        self.node_color = QtGui.QColor(*background_color)

    def paint(self, painter, option=None, widget=None):
        """
        Paints the python_node_interface on the given painter.

        Args:
            painter (QtGui.QPainter): The painter to use for drawing the python_node_interface.
            option (QStyleOptionGraphicsItem): The style options to use for drawing the python_node_interface (optional)
            widget (QWidget): The widget to use for drawing the python_node_interface (optional).
        """
        ...
        gradient.setColorAt(0, self.title_color.lighter())  # Start color (light)
        gradient.setColorAt(1, self.title_color.darker())  # End color (dark)
    ...
    def build(self):
        """
        Builds the python_node_interface by constructing its graphical representation.

        This method calculates the dimensions of the python_node_interface, sets the fonts for various elements,
        and adds the necessary graphical components to the python_node_interface, such as the title, type,
        and pins. Once the graphical representation of the python_node_interface is constructed, the `setPath` method
        is called to set the path for the python_node_interface.

        Returns:
            None.
        """

        # Configure the widget side of things. We need to get the size of the widget before building the rest of the
        ...
        self.title_bg_path.addRect(total_width / 2 - 10, -total_height / 2 + bg_height - 10, 10, 10)  # right corner
